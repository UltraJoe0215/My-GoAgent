...
def is_google_ip(ipaddr):
    if ipaddr in ('210.242.127.55', '203.133.8.24', '202.39.143.118', '27.100.64.244', '139.175.107.153'):
        return False
    if ipaddr.startswith(('139.175','27.100','202.39','60.199','203.133','210.242','173.194.', '207.126.', '209.85.', '216.239.', '64.18.', '64.233.', '66.102.', '66.249.', '72.14.', '74.125.')):
        return True
    return False
